...
const endpointUrl = "opc.tcp://iot-dmz-connector.c.agromation-grow-room-control.internal:4334";

const localURL = "opc.tcp://localhost:4334";

const connectAndGetData = async function () {
    try {
        // step 1 : connect to
...
const connectAndStreamData = async () => {
    try {
        // step 1 : connect to

        await client.connect(localURL);
        console.log("connected !");
...
module.exports = {
    connectAndGetData: connectAndGetData,
    connectAndStreamData: connectAndStreamData
}